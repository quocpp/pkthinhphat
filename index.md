...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-V4T5BLYBGH"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-V4T5BLYBGH');
  </script>
</head>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <p> -Đặc biệt trang bị hệ thống CT scan Connebeam 3D hiện đại bậc nhất.<br>
                ...
                <strong>- Quan trọng nhất phẩu thuật răng khôn, xác định vị trí nhổ răng để không chạm dây thần kinh</strong><br>
...
<!--     <section id="departments" class="departments">
    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <div class="section-title">
          <h2>ĐỘI NGŨ CHUYÊN GIA, BÁC SĨ TẠI X-Quang THỊNH PHÁT</h2>
          <p>Hãy cùng gặp gỡ những bác sĩ với chuyên môn cao tại x-quang Thịnh Phát để được tư vấn một cách tốt nhất.</p>
        </div>
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                <h4>Phạm Phú Mận</h4>
                <span>KTV chẩn đoán hình ảnh</span>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>X-quang Thinh Phat</span></strong>. All Rights Reserved
        </div>
      </div>
